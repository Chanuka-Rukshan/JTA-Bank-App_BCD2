...
<html>
<head>
    <title>JTA Bank | Transfer Funds</title>
    <!-- Tailwind CSS CDN -->
        ...
        <div class="flex items-center justify-between h-16">
            ...
            <div class="hidden md:block">
                <div class="ml-10 flex items-baseline space-x-2">
                    ...
                    <!-- Active State for Transfer -->
                    <a href="transfer"
                       class="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-semibold shadow-sm transition">Transfer</a>
...
<main class="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 w-full">
    ...
    <div class="max-w-md mx-auto">
        ...
        <div class="text-center mb-8">
            <h1 class="text-3xl font-extrabold text-gray-900">Transfer Funds</h1>
            <p class="mt-2 text-gray-500 font-medium">Move money securely between accounts.</p>
        </div>
        ...
        <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
            <form action="transfer" method="post" class="space-y-6">
                ...
                <div>
                    <label for="sourceAccountNo" class="block text-sm font-semibold text-gray-700 mb-2">From Account (Source)</label>
                    <div class="relative">
                        <select name="sourceAccountNo" id="sourceAccountNo" required
                ...
                <!-- Amount Input -->
                <div>
                    <label for="amount" class="block text-sm font-semibold text-gray-700 mb-2">Amount to Transfer</label>
